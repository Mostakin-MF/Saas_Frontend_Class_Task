      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            A comprehensive SaaS platform for event management. Register attendees, manage profiles, and organize events with ease.
          </p>
          ...
          {[
            {
              ...
              description: "Easily manage and track event attendees with detailed profiles.",
              icon: "👥"
            },
            {
            ...
            },
            {
              ...
              description: "Create and manage attendee profiles with comprehensive information.",
              icon: "📝"
            }
          ].map((feature, idx) => (
            <div
